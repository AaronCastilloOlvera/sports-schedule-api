...
class FixtureBuilder:
    ...
    def build_team_stats(self, fixture_id, home_team_id, raw_stats):
        rows = []
    ...
    def build_events(self, fixture_id, raw_events):
        rows = []
        for e in raw_events:
    ...
    def build_lineups(self, fixture_id, raw_lineups):
        rows = []
    ...
    def build_player_stats(self, fixture_id, raw_player_stats):
        rows = []
